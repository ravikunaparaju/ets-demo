...
// Home page elements
	...
	public final String homePage = "//div[@class='vesta_hp_hero_carousel']";
	public final String searchBox = "//input[@id='search-query']";
	public final String searchButton = "//button[@class='btn btn-primary']";
	public final String searchResults = "//h1[@class='conform-heading display-inline']";
